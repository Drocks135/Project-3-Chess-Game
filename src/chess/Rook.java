...
public class Rook extends ChessPiece {
    ...
    public boolean isCastling(Move move, IChessPiece[][] board) {         //FIXME does castling require action from rook or just game logic; castling is initiated by king
        //probably not because moving rook to castling position is also legal but has different meaning
        return false;
    }
